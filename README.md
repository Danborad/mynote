...
services:
  app:
    image: ${MYNOTE_IMAGE:-zhong12138/mynote:1.0.7}
...
- `MYNOTE_IMAGE`：默认镜像，通常为 `zhong12138/mynote:1.0.7`
...
- 支持离线模式与重新连接后的同步流程
- 当前版本：`1.0.7`
- APK 下载：[releases/mynote-android-v1.0.7.apk](releases/mynote-android-v1.0.7.apk)
