...
services:
  app:
    image: ${MYNOTE_IMAGE:-zhong12138/mynote:1.0.4}
...
- `MYNOTE_IMAGE`：默认镜像，通常为 `zhong12138/mynote:1.0.4`
...
- 支持离线模式与重新连接后的同步流程
- 当前版本：`1.0.4`
- APK 下载：[releases/mynote-android-v1.0.4.apk](releases/mynote-android-v1.0.4.apk)
...
```text
SHA256  63ab9e4002968a6c747e8848a0875884c97a242faa3e9337256b6a01225dc2bb
```
